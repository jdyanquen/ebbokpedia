...
import com.jcode.ebookpedia.web.service.UserProfileService;
import com.jcode.ebookpedia.web.service.UserService;
...
public class AppController {
	...
	public String editUser(@PathVariable String ssoId, ModelMap model) {
		UserAccount user = userService.findBySSO(ssoId);
		model.addAttribute("user", user);
	...
	public String updateUser(@Valid UserAccount user, BindingResult result, ModelMap model, @PathVariable String ssoId) {
